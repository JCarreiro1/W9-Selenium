...
describe('Web App Tests', function () {
    ...
    // THIS IS A NEW TEST
    describe('Navigating to contact page', function () {
        it('should select the contact tab', async function () {
            ...
            try {
                ...
                console.log('Error message for contact page found');
            } catch (err) {
                throw new Error('Expected error message for contact page not found');
            }
        });
    });
});
